      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 grid grid-cols-2 gap-6 text-center text-gray-500 sm:grid-cols-3 lg:grid-cols-6">
          {customerLogos.map((logo) => (
            <div
              key={logo.name}
              className="flex h-28 flex-col items-center justify-center rounded-2xl border border-gray-100 px-4 py-3 text-sm font-semibold uppercase tracking-wide text-gray-400 transition hover:border-blue-200 hover:text-blue-600"
            >
